class Immo::Promo::Certification < ApplicationRecord
  ...
  validates :certification_type, inclusion: { in: %w[insurance qualification rge environmental] }
  validates :name, presence: true
  validates :issuing_authority, presence: true
  validates :certificate_number, presence: true, uniqueness: { scope: :stakeholder_id }
