...
RSpec.describe Immo::Promo::TasksController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'with valid params' do
      ...
      it 'redirects to phase' do
        ...
        expect(response).to redirect_to(immo_promo_project_phase_task_path(project, phase, Immo::Promo::Task.last))
      end
    end
  ...
  describe 'PATCH #update' do
    ...
    it 'redirects to task' do
      ...
      expect(response).to redirect_to(immo_promo_project_phase_task_path(project, phase, task))
    end
  end
  ...
  describe 'DELETE #destroy' do
    ...
    it 'redirects to phase' do
      ...
      expect(response).to redirect_to(immo_promo_project_phase_path(project, phase))
    end
  end
