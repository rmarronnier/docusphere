...
ActiveRecord::Schema[7.1].define(version: 2025_06_13_014406) do
  ...
  create_table "documents", force: :cascade do |t|
    ...
    t.index ["last_viewed_at"], name: "index_documents_on_last_viewed_at"
    t.index ["last_viewed_by_id"], name: "index_documents_on_last_viewed_by_id"
